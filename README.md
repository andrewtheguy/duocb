...
| **Manual** (testing only) | none — you carry the code | one pairing code (node id + session secret) | Argon2id PIN challenge-response (mutual, in-band) | **not required** on the same LAN (mDNS) |
